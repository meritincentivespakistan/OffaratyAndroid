...
import com.riyadhbank.Retrofit.AboutUsModel;
...
public class AboutUsActivity extends AppCompatActivity implements Interface.OnAboutUs {
    ...
    void getfvrtData() {
        ...
        if (GlobalClass.isNetworkConnected(this)) {
            ...
            params.put(Constants.action, Constants.get_content);
            params.put(Constants.key, LangType);
            params.put(Constants.appid, GlobalClass.Riyadh);

            app.getApiRequestHelper ().getAboutUs (params, new ApiRequestHelper.OnRequestComplete () {
                @Override
                public void onSuccess(Object object) {
                    customDialog.dismiss();
                    AboutUsModel aboutUsModel = (AboutUsModel) object;
                    Log.e ("in", "success");
                    if (aboutUsModel != null) {
                        txtAbout.setText(aboutUsModel.getMsg().getContent());
                       ...
                       /* favouriteAdapter = new FavouriteAdapter(getActivity(), favouriteModal.getOffercontent(), GlobalClass.FAVOURITE, FavouriteFragment.this);
                        ...
                        Toast.makeText (AboutUsActivity.this, "UNPROPER_RESPONSE",Toast.LENGTH_LONG).show();
                    }
                    // dismisProgressHUD ();
                }
                ...
                public void onFailure(String apiResponse) {
                    ...
                    Toast.makeText (AboutUsActivity.this, apiResponse,Toast.LENGTH_LONG).show();
                }
            });
