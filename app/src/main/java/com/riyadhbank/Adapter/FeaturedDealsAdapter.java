...
public class FeaturedDealsAdapter extends RecyclerView.Adapter<FeaturedDealsAdapter.ViewHolder> {
    ...
    Activity activity;
    List<Offercontent> offerModals;
    String type;
    Interface.OnClickHomeOrCategoryFavourite onClickHomeOrCategoryFavourite;
    private int lastPosition = -1;

    public FeaturedDealsAdapter(Activity activity, List<Offercontent> offerModals, String type, Interface.OnClickHomeOrCategoryFavourite onClickHomeOrCategoryFavourite) {
    ...
    public void onBindViewHolder(FeaturedDealsAdapter.ViewHolder holder, final int position) {
        ...
        if (offerModals.get(position).getSelected()==1) {
