...
public class ImageSliderAdapter extends PagerAdapter {
    ...
    Activity activity;
    List<DashboardModel.Slidercontent> sliderModals;
    AutoScrollViewPager imageSlider;

    public ImageSliderAdapter(Activity activity, List<DashboardModel.Slidercontent> sliderModals, AutoScrollViewPager imageSlider) {
