...
public class FavouriteAdapter extends RecyclerView.Adapter<FavouriteAdapter.ViewHolder> {
    ...
    Activity activity;
    List<FavouriteModel.Offercontent> favouriteModals;
    String type;
    Interface.OnClickFavourite onClickFavourite;
    private int lastPosition = -1;

    public FavouriteAdapter(Activity activity, List<FavouriteModel.Offercontent> favouriteModals, String type, Interface.OnClickFavourite onClickFavourite) {
    ...
    public void onBindViewHolder(FavouriteAdapter.ViewHolder holder, final int position) {
        ...
        if (favouriteModals.get(position).getSelected()==1) {
