...
//                    showToastMessage("Please provide first name");
                    edtFname.setError(getResources().getString(R.string.enterfname));
                } else if (Lname.equals("")) {

                    //showToastMessage("Please provide last name");
                    edtLname.setError(getResources().getString(R.string.enterlname));
                } else if (Email.equals("")) {

                    //showToastMessage("Please provide email");
                    edtEmail.setError(getResources().getString(R.string.enteremail));

                } else if (!Email.matches(GlobalClass.emailPattern)) {

                    //showToastMessage("Invalid email. Please enter valid email");
                    edtEmail.setError(getResources().getString(R.string.invalidemail));
                }
                else if (MobileNumber.equals("")) {

                   // showToastMessage("Please enter phone number");
                    edtMobileNumber.setError(getResources().getString(R.string.entermobile));
                }

                else if (!MobileNumber.matches(GlobalClass.KSAnumberPattren)) {

                   // showToastMessage("Please provide valid KSA number");
                    edtMobileNumber.setError(getResources().getString(R.string.entervalidksa));
                }
                else if (Password.equals("")) {

                   // showToastMessage("Password required");
